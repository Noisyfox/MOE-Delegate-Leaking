...
@ObjCClassName( "BrowserViewController" )
@RegisterOnStartup
public class BrowserViewController extends UIViewController implements UIWebViewDelegate
{
	@Owned
	@Selector( "alloc" )
	...
	protected BrowserViewController( Pointer peer )
	{
		super( peer );
	}
